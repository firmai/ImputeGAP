...
def native_spirit(__py_matrix, __py_k, __py_w, __py_lambda):
    """
...
def spirit(incomp_data, k, w, lambda_value, logs=True, lib_path=None):
    """
    ...
    recov_data = native_spirit(incomp_data, k, w, lambda_value)
