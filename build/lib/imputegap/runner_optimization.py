...
cdrec = Imputation.MatrixCompletion.CDRec(infected_data).impute(user_def=False, params={"ground_truth": ts_1.data, "optimizer": "bayesian", "options": {"n_calls": 3}})
...
ts_1.plot(input_data=ts_1.data, incomp_data=infected_data, imputed_data=cdrec.recov_data, title="imputation", max_series=1, save_path="./assets", display=True)
