...
optimiser_ray = {"optimizer": "ray_tune"}
optimizers_demo = [optimiser_ray]
...
if not reconstruction:
    # START THE ANALYSIS
    list_results, sum_scores = Benchmark().eval(algorithms=algorithms_all, datasets=datasets_full, patterns=patterns_demo, x_axis=x_axis, optimizers=optimizers_demo, save_dir=save_dir, runs=nbr_run)
else:
