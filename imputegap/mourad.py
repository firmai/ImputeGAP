...
cdrec = Imputation.PatternSearch.STMVL(ts_mask).impute(user_def=False, params={"input_data": ts_1.data, "optimizer": "ray_tune", "options": {"n_calls": 1}})
...
print("OVER________________________________________________________________________________________________________")