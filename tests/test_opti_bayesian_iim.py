...
class TestOptiIMM(unittest.TestCase):
    ...
    def test_optimization_bayesian_iim(self):
        ...
        """
        gap = TimeSeries(utils.search_path("chlorine"), limitation_values=100)
        ...
        _, metrics_optimal = Imputation.Regression.iim_imputation(ground_truth=gap.data, contamination=ts_contaminated, params=params_optimal)
        _, metrics_default = Imputation.Regression.iim_imputation(ground_truth=gap.data, contamination=ts_contaminated, params=params)
